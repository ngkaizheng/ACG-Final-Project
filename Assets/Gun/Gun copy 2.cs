...
//         //Check current tick is simulation or forward
//         Debug.Log($"Current Tick: {Runner.Tick}, IsForward: {Runner.IsForward}, IsSimulation: {Runner.IsResimulation}");
//         // if (Object.HasInputAuthority)
//         // {
//         if (Runner.IsForward)
//         {
//             // If this is a forward tick, we can safely play effects and calculate damage
//             PlayShootingEffects(direction);
//         }
//         // }
...
//     {
//         // if (!Object.HasInputAuthority) return; // Critical safety check
//         Debug.Log($"Playing shooting effects at Tick: {Runner.Tick}, IsForward: {Runner.IsForward}, IsSimulation: {Runner.IsResimulation}");
